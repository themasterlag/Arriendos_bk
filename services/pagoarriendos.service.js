  ...
  async findReportePorFechaYTipoPago(year,month, tipoReporte){
    ...
    switch (tipoReporte) {
      case 'bancolombia':
        ...
        orderType = ' ORDER BY numero_cuenta ASC'
        break;
      case 'otros-bancos':
        ...
        //SELECT "pago_arriendo"."id_pago_arriendo", "pago_arriendo"."canon", "contratodetalle"."id_contrato" AS "contratodetalle.id_contrato", "contratodetalle->autdetalle"."id_autorizado" AS "contratodetalle.autdetalle.id_autorizado", "contratodetalle->autdetalle"."numero_cuenta" AS "contratodetalle.autdetalle.numero_cuenta", "contratodetalle->autdetalle->entidadbancaria"."id_entidad_bancaria" AS "contratodetalle.autdetalle.entidadbancaria.id_entidad_bancaria", "contratodetalle->autdetalle->entidadbancaria"."entidad_bancaria" AS "contratodetalle.autdetalle.entidadbancaria.entidad_bancaria", "contratodetalle->autdetalle->clientedetalle"."id_cliente" AS "contratodetalle.autdetalle.clientedetalle.id_cliente", "contratodetalle->autdetalle->clientedetalle"."numero_documento" AS "contratodetalle.autdetalle.clientedetalle.numero_documento", "contratodetalle->autdetalle->clientedetalle"."nombres" AS "contratodetalle.autdetalle.clientedetalle.nombres", "contratodetalle->autdetalle->clientedetalle"."apellidos" AS "contratodetalle.autdetalle.clientedetalle.apellidos", "contratodetalle->autdetalle->clientedetalle"."tipo_documento" AS "contratodetalle.autdetalle.clientedetalle.tipo_documento", "contratodetalle->autdetalle->clientedetalle"."razon_social" AS "contratodetalle.autdetalle.clientedetalle.razon_social", "contratodetalle->autdetalle->clientedetalle"."digito_verificacion" AS "contratodetalle.autdetalle.clientedetalle.digito_verificacion", "contratodetalle->pvdetalle"."id_punto_venta" AS "contratodetalle.pvdetalle.id_punto_venta", "contratodetalle->pvdetalle"."codigo_sitio_venta" AS "contratodetalle.pvdetalle.codigo_sitio_venta", "contratodetalle->pvdetalle"."nombre_comercial" AS "contratodetalle.pvdetalle.nombre_comercial", "contratodetalle->pvdetalle->municipiodetalle"."id_municipio" AS "contratodetalle.pvdetalle.municipiodetalle.id_municipio", "contratodetalle->pvdetalle->municipiodetalle"."municipio" AS "contratodetalle.pvdetalle.municipiodetalle.municipio", "contconceptos"."id_detalle_concepto" AS "contconceptos.id_detalle_concepto", "contconceptos"."pago_concepto_valor" AS "contconceptos.pago_concepto_valor", "contconceptos"."id_concepto" AS "contconceptos.id_concepto", "contconceptos->conceptodetalle"."id_concepto" AS "contconceptos.conceptodetalle.id_concepto", "contconceptos->conceptodetalle"."codigo_concepto" AS "contconceptos.conceptodetalle.codigo_concepto", "contconceptos->conceptodetalle"."nombre_concepto" AS "contconceptos.conceptodetalle.nombre_concepto", "contconceptos->conceptodetalle"."tipo_concepto" AS "contconceptos.conceptodetalle.tipo_concepto" FROM "arriendos"."pago_arriendo" AS "pago_arriendo" INNER JOIN "arriendos"."contrato" AS "contratodetalle" ON "pago_arriendo"."id_contrato" = "contratodetalle"."id_contrato" INNER JOIN "arriendos"."autorizado" AS "contratodetalle->autdetalle" ON "contratodetalle"."id_autorizado" = "contratodetalle->autdetalle"."id_autorizado" INNER JOIN "arriendos"."entidad_bancaria" AS "contratodetalle->autdetalle->entidadbancaria" ON "contratodetalle->autdetalle"."entidad_bancaria" = "contratodetalle->autdetalle->entidadbancaria"."id_entidad_bancaria" LEFT OUTER JOIN "arriendos"."cliente" AS "contratodetalle->autdetalle->clientedetalle" ON "contratodetalle->autdetalle"."id_cliente" = "contratodetalle->autdetalle->clientedetalle"."id_cliente" LEFT OUTER JOIN "arriendos"."punto_de_venta" AS "contratodetalle->pvdetalle" ON "contratodetalle"."id_punto_venta" = "contratodetalle->pvdetalle"."id_punto_venta" LEFT OUTER JOIN "arriendos"."municipio" AS "contratodetalle->pvdetalle->municipiodetalle" ON "contratodetalle->pvdetalle"."id_municipio" = "contratodetalle->pvdetalle->municipiodetalle"."id_municipio" LEFT OUTER JOIN "arriendos"."pago_concepto" AS "contconceptos" ON "pago_arriendo"."id_pago_arriendo" = "contconceptos"."id_pago_arriendo" LEFT OUTER JOIN "arriendos"."conceptos" AS "contconceptos->conceptodetalle" ON "contconceptos"."id_concepto" = "contconceptos->conceptodetalle"."id_concepto" WHERE EXTRACT(YEAR FROM fecha_periodo) = 2023 AND EXTRACT(MONTH FROM fecha_periodo) = 8 ORDER BY "contratodetalle->autdetalle->entidadbancaria".entidad_bancaria ASC, "contratodetalle->autdetalle->clientedetalle".razon_social ASC;
