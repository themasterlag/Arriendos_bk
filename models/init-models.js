...
function initModels(sequelize) {
  ...
  contrato_tipo_servicio.belongsTo(contrato, {
    as: 'id_contrato_contrato',
    foreignKey: 'id_contrato',
  });
  contrato.hasMany(contrato_tipo_servicio, {
    as: 'contrato_tipo_servicios',
    foreignKey: 'id_contrato',
  });
  ...
  contrato_tipo_servicio.belongsTo(tipo_servicio, {
    as: 'id_tipo_servicio_tipo_servicio',
    foreignKey: 'id_tipo_servicio',
  });
  tipo_servicio.hasMany(contrato_tipo_servicio, {
    as: 'contrato_tipo_servicios',
    foreignKey: 'id_tipo_servicio',
  });
